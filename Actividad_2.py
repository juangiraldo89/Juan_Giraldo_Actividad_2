...
csv_path = "resultados_actividad_2.csv"
...
plt.scatter(x, y)
image_path = "grafica_punto_11.png"
...
plt.legend()
image_path = "grafica_punto_12.png"
plt.savefig(image_path)
...
image_path = "grafica_punto_13.png"
plt.savefig(image_path)
...
plt.colorbar()
image_path = "grafica_punto_14.png"
plt.savefig(image_path)
...
plt.colorbar()
image_path = "grafica_punto_15.png"
plt.savefig(image_path)
...
plt.legend()
image_path = "grafica_punto_16.png"
plt.savefig(image_path)
...
image_path = "grafica_punto_17.png"
plt.savefig(image_path)
...
plt.legend()
image_path = "grafica_punto_18.png"
plt.savefig(image_path)
...
plt.legend()
image_path = "grafica_punto_19.png"
plt.savefig(image_path)
...
plt.legend()
image_path = "grafica_punto_20.png"
plt.savefig(image_path)
...
plt.legend()
image_path = "grafica_punto_21.png"
plt.savefig(image_path)